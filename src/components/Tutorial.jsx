...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Run the clock here: Play or Pause, Step to advance a week at a time, the current Week, and the speed control.',
    target: '[data-tour="controls"]',
  },
  {
    title: 'Society and a fixed money supply',
    body: 'The class mix plus the economy headline stats: the Gini inequality index, average wealth and mobility. The money supply is fixed, so Total capital and the Treasury always add up to the same amount.',
